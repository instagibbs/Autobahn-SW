...
public class WampConnection extends WebSocketConnection implements Wamp {
   ...
   protected WampWriter mWebSocketWriterHandler;
   ...
   protected void createReader() {
      mWebSocketReader = new WampReader(mCalls, mSubs, mHandler, mSocket, mWebSocketOptions, "AutobahnReader");
